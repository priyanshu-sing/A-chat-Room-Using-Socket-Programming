    ...
    public static void main(String args[]) throws IOException {
       ...
       ServerSocket ss = new ServerSocket(1234);
        ...
        while (true) 
        {
            ...
            ClientHandler mtch = new ClientHandler(s,name, dis, dos,received);
...
class ClientHandler implements Runnable 
{
    ...
    public ClientHandler(Socket s, String name,
                            DataInputStream dis, DataOutputStream dos,String received) {
        this.dis = dis;
        this.dos = dos;
        this.name = name;
        this.s = s;
    ...
    public void run() {
        ...
        while (true) 
        {
            try
            {
               ...
               // msg_area.setText(msg_area.getText().trim()+"  Server   "+msgin);
                if(this.received.equals("logout")){
